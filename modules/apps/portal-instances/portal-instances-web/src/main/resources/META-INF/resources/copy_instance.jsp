	...
	>
		<div class="copy-instance-content">
			<div class="px-4 py-2">
				...
				<aui:input name="sourceCompanyId" type="hidden" value='<%= ParamUtil.getLong(request, "sourceCompanyId") %>' />
				...
				<aui:input label="destination-company-id" name="destinationCompanyId" type="number" />
			</div>
		</div>
