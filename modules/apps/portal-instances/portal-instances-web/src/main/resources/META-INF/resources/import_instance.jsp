...
<portlet:actionURL name="/portal_instances/import_instance" var="importInstanceURL" />

<div class="import-instance-alert-container"></div>

<clay:container-fluid>
	<liferay-frontend:edit-form
		action="<%= importInstanceURL %>"
		method="post"
		name="fm"
		onSubmit="event.preventDefault();"
		validateOnBlur="<%= false %>"
	>
		<div class="import-instance-content">
			<div class="px-4 py-2">
		...
		<div class="import-instance-loading align-items-center d-none flex-column justify-content-center">
...
<liferay-frontend:component
	module="{ImportInstance} from portal-instances-web"
/>