...
public class CopyInstanceMVCActionCommandTest {
	...
	public void testErrorForBlankName() throws Exception {
		_assertError(
			...
			_getMockActionRequest("name", StringPool.BLANK));
	...
	public void testErrorForBlankVirtualHostname() throws Exception {
		_assertError(
			...
			_getMockActionRequest("virtualHostname", StringPool.BLANK));
	...
	public void testErrorForBlankWebId() throws Exception {
		_assertError(
			...
			_getMockActionRequest("webId", StringPool.BLANK));
	...
	@Test
	public void testErrorForIllegalArgumentExceptionWithoutDestinationCompanyId()
		throws Exception {
