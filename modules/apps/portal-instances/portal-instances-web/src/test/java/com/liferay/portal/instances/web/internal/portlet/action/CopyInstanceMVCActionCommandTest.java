...
public class CopyInstanceMVCActionCommandTest {
	...
	public void testDestinationCompanyIdErrorForIllegalArgumentException()
		...
		_assertErrorMessage(
			_getMockActionRequest(), new IllegalArgumentException(),
	...
	public void testNameErrorForDirectCompanyNameException() throws Exception {
		_assertErrorMessage(
			_getMockActionRequest(), new CompanyNameException(),
			"please-enter-a-valid-name");
	}
	...
	public void testUnexpectedErrorForIllegalArgumentExceptionWithoutDestinationCompanyId()
		...
		_assertErrorMessage(
			mockActionRequest, new IllegalArgumentException(),
	...
	public void testUnexpectedErrorForUnmappedException() throws Exception {
		_assertErrorMessage(
			_getMockActionRequest(), new RuntimeException(),
			"an-unexpected-error-occurred");
	}
	...
	public void testVirtualHostErrorForDirectCompanyVirtualHostException()
		...
		_assertErrorMessage(
			_getMockActionRequest(), new CompanyVirtualHostException(),
			"please-enter-a-valid-virtual-host");
	}
	...
	public void testWebIdErrorForDirectCompanyWebIdException()
		...
		_assertErrorMessage(
			_getMockActionRequest(), new CompanyWebIdException(),
			"please-enter-a-valid-web-id");
	}

	private void _assertErrorMessage(
			MockActionRequest mockActionRequest, Exception exception,
