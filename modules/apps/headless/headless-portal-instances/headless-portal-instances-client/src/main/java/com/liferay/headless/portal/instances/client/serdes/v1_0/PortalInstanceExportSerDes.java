...
public class PortalInstanceExportSerDes {
	...
	public static String toJSON(PortalInstanceExport portalInstanceExport) {
		...
		if (portalInstanceExport.getSchemaName() != null) {
			...
			sb.append(_escape(portalInstanceExport.getSchemaName()));
	...
	public static Map<String, String> toMap(
		...
		if (portalInstanceExport.getSchemaName() == null) {
			...
			map.put(
				"schemaName",
				String.valueOf(portalInstanceExport.getSchemaName()));
		}
	...
	public static class PortalInstanceExportJSONParser
		...
		protected boolean parseMaps(String jsonParserFieldName) {
			if (Objects.equals(jsonParserFieldName, "schemaName")) {
				return false;
			}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "schemaName")) {
				if (jsonParserFieldValue != null) {
					portalInstanceExport.setSchemaName(
...
// LIFERAY-REST-BUILDER-HASH:1812363550