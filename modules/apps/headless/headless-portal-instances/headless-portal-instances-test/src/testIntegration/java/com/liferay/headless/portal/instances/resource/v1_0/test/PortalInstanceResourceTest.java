...
public class PortalInstanceResourceTest
	...
	public void testPostPortalInstanceImport() throws Exception {
		_testPostPortalInstanceImportExistingCompany();
		_testPostPortalInstanceImportForbidden();
		_testPostPortalInstanceImportIdempotencyKey();
	...
	private void _testPostPortalInstanceImportExistingCompany()
		throws Exception {
		...
		Assert.assertEquals(
			_company.getCompanyId(), (long)portalInstance.getCompanyId());
		Assert.assertEquals(_company.getMx(), portalInstance.getDomain());
		Assert.assertEquals(
			_company.getWebId(), portalInstance.getPortalInstanceId());
		Assert.assertEquals(
			_company.getVirtualHostname(), portalInstance.getVirtualHost());
	}
	...
	private void _testPostPortalInstanceImportIdempotencyKey()
		throws Exception {
		...
		Assert.assertEquals(
			portalInstance1.getCompanyId(), portalInstance2.getCompanyId());
		Assert.assertEquals(
