...
@Generated("")
@GraphQLName(
	description = "The result of a portal instance export operation.",
...
public class PortalInstanceExport implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The DB partition schema name (format lexported_[companyId])."
	)
...
// LIFERAY-REST-BUILDER-HASH:958059544