							...
							<div class="add-application-panel panel">
								<div class="panel-heading" id="<portlet:namespace />addApplicationHeading" role="tab">
									<div class="panel-title">
										<a aria-controls="#<portlet:namespace />addApplicationCollapse" aria-expanded='<%= selectedTab.equals("applications") %>' class='<%= selectedTab.equals("applications") ? StringPool.BLANK : "collapsed" %> collapse-icon collapse-icon-middle panel-toggler' data-parent="#<portlet:namespace />Accordion" data-qa-id="addMenuAddApplicationCategory" data-toggle="collapse" href="#<portlet:namespace />addApplicationCollapse" role="button">
