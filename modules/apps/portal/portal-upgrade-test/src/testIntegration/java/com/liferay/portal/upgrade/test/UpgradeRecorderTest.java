...
public class UpgradeRecorderTest {
	...
	@Test
	public void testFailureStatusByPendingModuleUpgrade() throws Exception {
	...
	@Test
	public void testFailureStatusByVerifyException() throws Exception {
		StartupHelperUtil.setUpgrading(true);
	...
	@Test
	public void testSuccessStatusByNoUpgrades() {
		StartupHelperUtil.setUpgrading(true);
	...
	@Test
	public void testSuccessStatusWithUnrelatedError() throws Exception {
		StartupHelperUtil.setUpgrading(true);
	...
	@Test
	public void testSuccessStatusWithWarning() throws Exception {
		StartupHelperUtil.setUpgrading(true);
	...
	@Test
	public void testUnresolvedStatusByUnsatisfiedComponent() throws Exception {
		BundleContext bundleContext = _bundle.getBundleContext();
